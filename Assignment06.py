...
# FSharif,2.19.2022,Created started script
# Fatima Sharif,2.22.22,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        for row in list_of_rows:
            if row["Task"].lower() == task.lower(): list_of_rows.remove(row)
        print("row removed")
        return list_of_rows
